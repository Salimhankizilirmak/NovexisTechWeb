  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-28 pb-16 sm:pt-36 sm:pb-20">
        ...
        <h1 className="mt-4 text-3xl sm:text-5xl font-extrabold tracking-tight text-gray-900 dark:text-red-50 max-w-3xl">
          Yalıtımda Güvenilir Yerli Üretim, Global Standartlar
        </h1>
        <p className="mt-4 text-lg font-semibold text-gray-900 dark:text-red-800 max-w-2xl">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          ...
          <a href="/iletisim#teklif-ara" className="btn rounded-full bg-white text-red-700 hover:bg-red-50 dark:bg-red-900 dark:text-red-100 dark:hover:bg-red-800">Hızlı Teklif</a>
        </div>
      </div>
    </section>
  );
